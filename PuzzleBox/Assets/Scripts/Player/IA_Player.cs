...
public partial class @IA_Player: IInputActionCollection2, IDisposable
{
    ...
    ""maps"": [
        {
            ""name"": ""PlayerInputMap"",
            ""id"": ""0373b77a-1ecb-4cc0-a8f8-c361a6be8d7c"",
            ""actions"": [
                {
                    ""name"": ""SwitchState"",
                    ""type"": ""Button"",
                    ""id"": ""5c6aa14f-d1ee-4320-84f8-080700f16e9d"",
                    ""expectedControlType"": """",
                    ""processors"": """",
                    ""interactions"": """",
            ...
            ""bindings"": [
                {
                    ""name"": """",
                    ""id"": ""b1ffe809-cdb1-445f-a966-0e04c6d64bcb"",
                    ""path"": ""<Keyboard>/space"",
                    ""interactions"": """",
                    ""processors"": """",
    ...
    ""controlSchemes"": [
        ...
        m_PlayerInputMap_SwitchState = m_PlayerInputMap.FindAction("SwitchState", throwIfNotFound: true);
    }

    ~@IA_Player()
    {
        UnityEngine.Debug.Assert(!m_PlayerInputMap.enabled, "This will cause a leak and performance issues, IA_Player.PlayerInputMap.Disable() has not been called.");
    }
    ...
    private readonly InputAction m_PlayerInputMap_SwitchState;
    /// <summary>
    ...
    public struct PlayerInputMapActions
    {
        ...
        /// </summary>
        public PlayerInputMapActions(@IA_Player wrapper) { m_Wrapper = wrapper; }
        /// <summary>
        /// Provides access to the underlying input action "PlayerInputMap/SwitchState".
        /// </summary>
        public InputAction @SwitchState => m_Wrapper.m_PlayerInputMap_SwitchState;
        /// <summary>
